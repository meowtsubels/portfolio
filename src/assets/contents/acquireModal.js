								...
								<div className="container">
									...
									<p>
										...
										<div className={"col" + " " + "text-sm-center"}>
											<img className={"img-fluid" + " " + "mb-5" + " " + "imgDepth"} src={Images.acquire.acq1}/>
										</div>
									</div>
									<div className={"row" + " " + "mb-5"}>
										<div className={"col-md-6" + " " + "text-sm-center"}>
											<img className={"img-fluid" + " " + "imgDepth"} src={Images.acquire.acq2} />
										</div>
										<div className={"col-md-6" + " " + "text-sm-center"}>
											<img className={"img-fluid" + " " + "imgDepth"} src={Images.acquire.acq3} />
										</div>
									</div>
									<div className="row"> 
										<div className={"col" + " " + "text-sm-center"}>
											<img className={"img-fluid" + " " + "mb-5" + " " + "imgDepth"} src={Images.acquire.acq4}/>
										</div>
									</div>	
								</div>
							</div>
